const projects = [
    ...
    },
    {
        ...
        earnings: 11000,
        moneyEarned: 11000,
        earnedDate: "2025-05-19",
        tasks: [
            { id: 1, name: "Course structure design", status: "Completed" },
            { id: 2, name: "Video player integration", status: "Completed" },
            { id: 3, name: "Quiz system", status: "Completed" },
            { id: 4, name: "Progress tracking", status: "Completed" },
        ],
    },
